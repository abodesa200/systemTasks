...
import { Client } from "@/modules/users/types/usersType";
...
//   }),
//   status: z.string().nonempty("يرجى اختيار حالة العميل."),
//   type: z.string().nonempty("يرجى اختيار نوع العميل."),
...
export default function ClientsPage() {
  return <UsersPage initialClients={initialClients} type={"CLIENTS"} />;
}
